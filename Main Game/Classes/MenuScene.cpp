...
bool CMenuScene::init()
{
    ...
    **/
	...
	cocos2d::ui::Button* exitButton = menu->getChildByName<cocos2d::ui::Button*>("exitGame");
	cocos2d::ui::RadioButton* radio = setting->getChildByName<cocos2d::ui::RadioButton*>("Audio_2");
